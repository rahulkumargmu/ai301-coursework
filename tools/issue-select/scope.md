...
I write Python for coursework and small projects, including FastAPI-style backends, tests, and docs. I want a first issue that is one bounded Python or documentation bug I can reproduce locally this week. I want to get better at reading an existing test suite and making a small, reviewable change. For this first issue I want to avoid large React/frontend work, CI/DevOps pipeline design, and tier-3 onboarding or benchmark tasks.
